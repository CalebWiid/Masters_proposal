...
\title{\bfseries
       \AorE{%-- Afrikaans ------------------------------------------
             ...
             Creating an Adaptive Gesture Recognition System Using Few-Shot Learning to Control a Photography Drone}}
...
\include{chaps-main/chap-workplan}
\include{chaps-main/chap-schedule}
\include{chaps-main/chap-risk_assessment}
